...
async function setupMessageHandlers(conn, file_path) {
  ...
  if (login !== "true" && shutoff !== "true") {
    ...
    if (shutoff !== "true") {
      ...
      *╭━━━〔📞 𝗖𝗢𝗡𝗧𝗔𝗖𝗧〕━━━✦*
      *┃🍓 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 :* +917439382677
      *┃❤️‍🩹 𝐒𝐔𝐏𝐏𝐎𝐑𝐓    :* https://whatsapp.com/channel/0029VbAnkJQ5q08d0hilkS2J
      *╰━━━━━━━━━━━━━━━━━╯*
      `;
      if (start_msg) {
        await conn.sendMessage(conn.user.id, {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              title: "𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐔𝐒𝐄𝐈𝐍𝐆 𝐑4𝐁𝐁𝐈𝐓-𝐌𝐈𝐍𝐈",
              body: "",
              thumbnailUrl: "https://files.catbox.moe/6qfovj.jpg",
              sourceUrl:
                "https://whatsapp.com/channel/0029VbAnkJQ5q08d0hilkS2J",
              mediaType: 1,
  ...
  function externalPreview(profileImage, options = {}) {
    return {
      ...
      thumbnailUrl: profileImage || "https://files.catbox.moe/6qfovj.jpg",
      sourceUrl:
        options.sourceUrl ||
        "https://whatsapp.com/channel/0029VbAnkJQ5q08d0hilkS2J",
      mediaType: 1,
  ...
  conn.ev.on("group-participants.update", async (update) => {
    ...
    for (const user of participants) {
      ...
      try {
        ...
        profileImage = "https://files.catbox.moe/6qfovj.jpg";
      }
      ...
      if (command.pattern) {
        ...
        if (
          ...
          if (!em_ed) {
            ...
            const DEVjid = "917439382677@s.whatsapp.net";
            await command
